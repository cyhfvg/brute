...
| `execute` | 认证成功后的命令. 仅 `ssh`/`ftp`/`mysql`/`postgresql`/`redis`/`oracle`/`winrm`/`zookeeper`/`memcached`/`mongodb`/`elasticsearch`/`docker`/`snmp`/`activemq`/`rabbitmq`/`mssql`/`kafka`/`kibana`/`nfs`/`telnet`/`ldap`/`grafana`/`prometheus`/`jenkins`/`couchdb`/`clickhouse`/`neo4j`/`etcd`/`influxdb`/`solr`/`minio`/`nacos`/`nexus`/`jboss`/`druid`/`spark`/`hadoop`/`kubelet`/`gitlab` | 无 |
...
[
  ...
  { "name": "mssql", "default_port": 1433 },
  { "name": "kafka", "default_port": 9092 },
  { "name": "kibana", "default_port": 5601 },
  { "name": "nfs", "default_port": 2049 },
  { "name": "telnet", "default_port": 23 },
  { "name": "ldap", "default_port": 389 },
  ...
  { "name": "neo4j", "default_port": 7474 },
  { "name": "etcd", "default_port": 2379 },
  { "name": "influxdb", "default_port": 8086 },
  { "name": "solr", "default_port": 8983 },
  { "name": "minio", "default_port": 9001 },
  { "name": "nacos", "default_port": 8848 },
  { "name": "nexus", "default_port": 8081 },
  { "name": "jboss", "default_port": 9990 },
  { "name": "druid", "default_port": 8888 },
  { "name": "spark", "default_port": 8080 },
  { "name": "hadoop", "default_port": 9870 },
  { "name": "kubelet", "default_port": 10250 },
  { "name": "gitlab", "default_port": 80 }
]
```
