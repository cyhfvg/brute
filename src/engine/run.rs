...
use crate::protocol::{
    ...
    http::HttpBasicModule, influxdb::InfluxDbModule, jboss::JbossModule, jenkins::JenkinsModule,
    kafka::KafkaModule, kibana::KibanaModule, kubelet::KubeletModule, ldap::LdapModule,
