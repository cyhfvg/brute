...
use crate::protocol::{
    ...
    rdp::RdpModule, redis::RedisModule, smb::SmbModule, ssh::SshModule,
    tomcat::TomcatManagerModule, vnc::VncModule, winrm::WinrmModule,
};
...
fn build_module(args: &ProtocolArgs) -> Arc<dyn BruteModule> {
    match args {
        ...
        ProtocolArgs::Http(args) => Arc::new(HttpBasicModule::new(
