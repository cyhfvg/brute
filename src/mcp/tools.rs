...
pub struct ProtocolOptions {
    ...
    /// Post-auth command for ssh/ftp/mysql/postgresql/redis/oracle/winrm/zookeeper/memcached/mongodb/elasticsearch/docker/snmp/activemq/rabbitmq/mssql/kafka/kibana/nfs/telnet/ldap/grafana/prometheus/jenkins/couchdb.
