...
pub struct ProtocolOptions {
    ...
    /// Post-auth command for ssh/ftp/mysql/postgresql/redis/oracle/winrm/zookeeper/memcached/mongodb/elasticsearch/docker/snmp/activemq/rabbitmq/mssql/kafka/kibana.
...
pub struct VerifyAccountParams {
    /// Protocol name: ssh, ftp, mysql, postgresql, redis, oracle, tomcat, smb, rdp, winrm, http, vnc, zookeeper, memcached, mongodb, elasticsearch, docker, snmp, activemq, rabbitmq, rsync, mssql, kafka, kibana.
    pub protocol: String,
