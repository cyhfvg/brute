...
pub struct VerifyAccountParams {
    /// Protocol name: ssh, ftp, mysql, postgresql, redis, oracle, tomcat, smb, rdp, winrm, http, vnc, zookeeper, memcached, mongodb, elasticsearch, docker, snmp, activemq, rabbitmq.
    pub protocol: String,
